...
return new class extends Migration
{
    ...
    public function up()
    {
     ...
     $procedure_create = "DROP PROCEDURE IF EXISTS `kelompok_1_create_courses_by_courses_id`;
         CREATE PROCEDURE `kelompok_1_create_courses_by_courses_id` (new_id int, new_study_program_id int, new_creator_user_id int, new_name varchar(255), new_code varchar(255), new_course_credit int(11), new_lab_credit int(11), new_type enum('mandatory', 'elective'), new_short_description text, new_minimal_requirement varchar (1024), new_study_material_summary text, new_learning_media text, new_created_at datetime, new_updated_at datetime)
         BEGIN
         INSERT INTO course
