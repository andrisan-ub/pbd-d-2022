...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        $procedure_create = "DROP PROCEDURE IF EXISTS `kelompok_1_read_criterias_and_criterias_level`;
        ...
        $procedure_create = "DROP PROCEDURE IF EXISTS `kelompok_1_read_student_user_and_course`;
